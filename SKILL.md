...
| What the founder needs | Load this |
|---|---|
| "How do I build credibility before applying?" | `skill/social-proof.md` |
| "How do I reach out to grant reviewers?" | `skill/cold-outreach.md` |
| "I need a co-founder / team for Colosseum" | `skill/cofounder-matching.md` |
